$(function () {
    ...
    let userListVideo = $("#users-list-video");
    ...
    //         let html = '';
    //         for(let i=0;i<data.length;i++){
    //             html += `<li class="my-video" style="color: ${data[i].color}">${addVideoStream(myVideo, data)}</li>`;
    //         }
    //         userListVideo.html(html)
    //     })
    // });
